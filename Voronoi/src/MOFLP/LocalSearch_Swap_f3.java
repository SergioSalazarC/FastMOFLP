...
public class LocalSearch_Swap_f3 implements LocalSearch {
    ...
    public LocalSearch_Swap_f3(HashMap<Point, LinkedList<Point>> grafo, int p, double d, ArrayList<Point> sites, long seed) {
