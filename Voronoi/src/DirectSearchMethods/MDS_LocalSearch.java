...
public class MDS_LocalSearch implements LocalSearch {
    ...
    public MDS_LocalSearch(HashMap<Point, LinkedList<Point>> grafo, int p, double d, ArrayList<Point> sites, Conjuntos_Infactibles fs , long seed) {
    ...
    public Solucion improveSolution(Solucion sol) {
        ...
        DirectSearchImprovement ds = new MultidirectionalSearch();
